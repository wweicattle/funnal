...
=======
      <dialog-title v-if="showDialog" dialogName="利郎整改审批表" @closedialog="showDialog = false">
        ...
        <!-- <yr-five></yr-five> -->
        <yr-six></yr-six>
>>>>>>> d406896ef44791944593ce46f1fd72a8d1ebc85e
      </dialog-title>
    </div>
  </div>
</template>
...
=======
import YrTwo from './views/StorePolicy/TestDialog/YrTwo.vue';
...
import YrSix from './views/StorePolicy/TestDialog/YrSix.vue';

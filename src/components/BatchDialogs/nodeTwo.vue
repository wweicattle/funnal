  ...
  <div class="partialPublic dialog-page">
    ...
    <div class="d-content">
      ...
      <div class="box-btns flexcenter">
        ...
        <el-button v-checkSubmit type="primary"
          >同意条款并确认补贴金额</el-button
        >
      </div>
    </div>
    <div class="box-basic flexcenter salesman special">
        ...
        .then((res) => {
          if (res.status == 200) {
            if (res.data.errcode == 0) {
              ...
              this.node2Result.fgszjltk = names;
              // this.goback();
            } else {
              this.$Message.error(
